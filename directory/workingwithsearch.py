    ...
    with sr.Microphone() as source:
        ...
        while app_running:
            try:
                ...
                # Define the main commands including 'search'
                commands = ["click", "right click", "start", "stop", "scroll on", "scroll off", "search"]
                ...
                if closest_match:
                    ...
                    if command == "search":
                        print("Say your search phrase now:")
                        audio = r.listen(source)  # Listen without timeout for the search phrase
                        search_phrase = r.recognize_google(audio).lower()
                        print(f"Search phrase: {search_phrase}")
                        pyautogui.typewrite(search_phrase + '\n')  # Type out the phrase and press Enter
                    elif command == "start":
                        toggle_eye_tracking()
                    elif command == "click":
                        pyautogui.click()
